...
\begin{center}
    \includegraphics[width=\textwidth]{Images/trajectoire.png}
\end{center}
...
\begin{center}
    \includegraphics[height=5cm]{Images/RMSE_x.png}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth]{Images/carte_reconstruite.png}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth]{Images/RMSE_z.png}
\end{center}
