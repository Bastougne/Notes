...
\titlegraphic{
    \vspace{-\baselineskip}
    \includegraphics[width=10cm]{Images/logos ONERA IMS.pdf}
}
...
\logo{
    ...
    \hspace{4.5cm}
    \includegraphics[width=5cm]{Images/logos ONERA IMS.pdf}
}
...
\begin{center}
    \includegraphics[width=\textwidth]{Images/carte magnétométrique.png}
\end{center}
...
\begin{center}
    \hspace*{-10mm}
    \includegraphics[width=\textwidth]{Images/krigeage.pdf}
\end{center}
...
\begin{center}
    \hspace{-10mm}
    \includegraphics[width=\textwidth]{Images/fenêtre.pdf}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth]{Images/navigation.pdf}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth]{Images/anomalie magnétique.pdf}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth,height=0.7\textheight]{Images/RMSE.png}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth,height=0.6\textheight]{Images/histogrammes.png}
\end{center}
