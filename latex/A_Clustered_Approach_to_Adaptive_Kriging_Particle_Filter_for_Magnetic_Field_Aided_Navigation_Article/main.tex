...
\begin{figure}[ht]
\centerline{\includegraphics[width=0.4\textwidth]{trajectoire.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=0.4\textwidth]{RMSE.png}}
\caption{RMSE over time of the tested filters} \label{fig:RMSE}
\end{figure}

\begin{figure}[ht]
\centerline{\includegraphics[width=0.4\textwidth]{histogrammes.png}}
