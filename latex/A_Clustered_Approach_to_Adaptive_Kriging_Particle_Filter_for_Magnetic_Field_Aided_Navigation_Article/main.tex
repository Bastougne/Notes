...
\begin{figure}[ht]
\centerline{\includegraphics[width=0.4\textwidth]{../../Images/Trajectoire EUSIPCO 2025 large.png}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=0.4\textwidth]{../../Images/RMSE EUSIPCO 2025.png}}
\caption{RMSE over time of the tested filters} \label{fig:RMSE}
\end{figure}

\begin{figure}[ht]
\centerline{\includegraphics[width=0.4\textwidth]{../../Images/Histogramme du nombre de données krigées EUSIPCO 2025.png}}
