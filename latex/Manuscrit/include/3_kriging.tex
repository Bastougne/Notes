...
\begin{proposition}[Exact interpolation in the noiseless case]
	...
	In particular, the error covariance reduces to the query noise $R$ alone, and vanishes when $R=0$. On the contrary, a positive training noise $\tilde{R}\succ0$ turns kriging into a smoother rather than an interpolator.
\end{proposition}
