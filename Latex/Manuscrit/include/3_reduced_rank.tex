...
\begin{remark}[Construction of the eigenfunctions]
	While Mercer's theorem establishes the existence of the decomposition presented by \eqref{eq:Mercer}, it does not provide a closed-form expression for $k_{r_{\mathrm{KL}}}$. In practice \cite{bib:reduced-rank}, additional assumptions on $k$, such as stationarity or specific spectral properties, are usually made in order to derive an explicit approximation of the form of \Cref{th:reduced_rank}.
\end{remark}
