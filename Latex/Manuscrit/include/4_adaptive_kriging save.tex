...
\begin{figure}[!htb]
	\centering\includegraphics[width=0.6\textwidth]{../../Images/Sélection des données de krigeage.png}
...
\begin{figure}[!htb]
	\centering\includegraphics[width=0.6\textwidth]{../../Images/Fenêtrage du krigeage adaptatif.pdf}
...
\begin{figure}[!htb]
	\centering\includegraphics[width=0.6\textwidth]{../../Images/Exemple de clustering.png}
