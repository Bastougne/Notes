...
A fundamental limitation of SIS is that the variance of the importance weights increases monotonically over time \cite{bib:sequential-imputations} as shown by \Cref{th:variance_weights}.
