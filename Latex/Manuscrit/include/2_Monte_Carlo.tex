...
\begin{proposition}[Optimal proposal density]\label{th:optimal_proposal}
	...
	\end{equation}
	the trajectory weight is determined by $\mathbf{x}_{0:k-1}$, so that the variance injected at step $k$ vanishes:
	\begin{equation}
