\textbf{TODO: à vérifier — quatre titres courts corrigés, les numéros étant relus dans
\texttt{build/main.aux}. Trois autres (3.12, 3.13, 3.15) redeviennent justes du seul fait
de la promotion de \cref{th:kriging_vague_prior}, ce qui indique qu'elle était une
proposition avant d'être rétrogradée.}
...
\section[Proof of Proposition 3.12]{Proof of \Cref{th:covariance_operator}}\label{sec:proof_Mercer_operator}
...
\section[Proof of Proposition 3.13]{Proof of \Cref{th:Mercer}}\label{sec:proof_Mercer}
...
\section[Proof of Proposition 3.15]{Proof of \Cref{th:reduced_rank_kriging}}\label{sec:proof_reduced_rank_kriging}
...
\section[Proof of Proposition 3.17]{Proof of \Cref{th:native_RKHS}}\label{sec:proof_native_RKHS}
