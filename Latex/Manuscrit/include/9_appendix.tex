...
\begin{proposition}[Gaussian conditioning \cite{bib:multivariate-normal}]\label{th:Gaussian_conditioning}
	\textbf{TODO: retirer les références dans les titres} For $n,p\in\mathbb{N}$, let $U\in\mathbb{R}^n$ and $V\in\mathbb{R}^p$ be jointly Gaussian random variables, of respective means $\mu_U,\mu_V$ and covariance matrices $A\succ0$ and $D\succ0$. There exists $B\in\mathcal{M}_{n,p}(\mathbb{R})$ such that:
	\begin{equation}
