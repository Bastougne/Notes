...
\begin{definition}[ymmetric positive definite matrix]\label{th:matrix_SPSD}
...
\begin{figure}[!htb]
	\centering\includegraphics[width=0.9\textwidth]{../../Images/Étapes du filtre de Kalman avec équations.pdf}
