...
\begin{remark}[Median assumptions]
	...
	\begin{equation}
		\left\{u\in\mathbb{R}\:|\:\mathbb{P}(\varphi(X)\leq u|Z=z)\geq\frac{1}{2}\text{ and }\mathbb{P}(\varphi(X)\geq u|Z=z)\geq\frac{1}{2}\right\}
	\end{equation}
...
\textbf{TODO+teaser le kernel Kalman filter} \cite{bib:UKF,bib:SRUKF}
