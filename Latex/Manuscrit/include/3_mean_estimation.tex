...
Beyond regression, the covariance kernel also induces functional representations exploited later in this thesis. \Cref{sec:reduced_rank} replaces the GP by a finite-dimensional projection to alleviate the cubic cost of kriging, and \cref{sec:RKHS} interprets kriging as minimum-norm interpolation in a reproducing kernel Hilbert space.
